...
infobox:
  ...
  - label: "Orbital Period"
    value:
      - "~9,861.75 days (sidereal)"
      - "~379.30 days (synodic)"
  - { label: "Average Orbital Speed", value: "20.4 km/s" }
  - { label: "Satellites", value: "12" }
  - { section: "Rotational Characteristics" }
  - { label: "Axial Tilt", value: "30°" }
  - label: "Rotational Period"
    value:
      - "18.25 hours (sidereal)"
      - "18.90 hours (synodic)"
  - { section: "Physical Characteristics" }
  - { label: "Mass", value: "3.0720 × 10²⁶ kg" }
  - { label: "Surface Area", value: "2.0106 × 10¹⁰ km²" }
  - { label: "Volume", value: "2.6808 × 10¹⁴ km³" }
  - { label: "Mean Radius", value: "40,000 km" }
  - { label: "Mean Density", value: "1.15 g/cm³" }
  - { label: "Surface Gravity", value: "12.81 m/s²" }
  - { label: "Albedo", value: "0.7" }
  - label: "Magnitude"
    value:
      - "+0.78 (apparent)"
      - "-8.51 (absolute)"
  - { section: "Surface Conditions" }
  - { label: "Effective Temperature", value: "71.63 K (-201.52 °C)" }
  - label: "Surface Temperature"
    value:
      - "Average: 80 K (-193 °C)"
      - "Minimum: 65 K (−208 °C)"
      - "Maximum: 95 K (-178 °C)"
  - { label: "Surface Pressure", value: "18.2 psi" }
