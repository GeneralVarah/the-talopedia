...
ooc: true
infobox:
  - { image: "/assets/old-media/media/argentis-1.jpg", caption: "" }
  - { section: "Orbital Characteristics" }
  - { label: "Central Body", value: "Ignian Barycenter" }
  - { label: "Semi-Major Axis", value: "4.2 AU" }
  - label: "Orbital Period"
    value:
      - "3,143.87 days (sidereal)"
      - "413.43 days (synodic)"
  - { label: "Average Orbital Speed", value: "29.86 km/s" }
  - { label: "Satellites", value: "2" }
  ...
  - { label: "Mass", value: "2.860 × 10²⁴ kg" }
  - { label: "Surface Area", value: "4.227 × 10⁸ km²" }
  - { label: "Volume", value: "8.173 × 10¹¹ km³" }
  - { label: "Mean Radius", value: "5,800 km" }
  - { label: "Mean Density", value: "3.50 g/cm³" }
  - { label: "Surface Gravity", value: "5.68 m/s²" }
  ...
  - { label: "Effective Temperature", value: "108.97 K (-164.18 °C)" }
  - label: "Surface Temperature"
    value:
      - "Average: ~109 K (-164 °C)"
      - "Minimum: ~70 K (-203 °C)"
      - "Maximum: ~140 K (-133 °C)"
  - { label: "Surface Pressure", value: "4.41 x 10-8 psi" }
