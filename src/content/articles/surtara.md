...
infobox:
  ...
  - label: "Orbital Period"
    value:
      - "274 days (sidereal)"
      - "52.5 days (synodic)"
  - { label: "Average Orbital Speed", value: "32.8 km/s" }
  - { section: "Rotational Characteristics" }
  - { label: "Axial Tilt", value: "15°" }
  - label: "Rotational Period"
    value:
      - "72 hours (sidereal)"
      - "73 hours (synodic)"
  - { section: "Physical Characteristics" }
  - { label: "Mass", value: "4.8700 × 10²⁴ kg" }
  - { label: "Surface Area", value: "4.6000 × 10⁸ km²" }
  - { label: "Volume", value: "9.3100 × 10¹¹ km³" }
  - { label: "Mean Radius", value: "6,052 km" }
  - { label: "Mean Density", value: "5.24 g/cm³" }
  - { label: "Surface Gravity", value: "8.87 m/s²" }
  - { label: "Albedo", value: "0.38" }
  - label: "Magnitude"
    value:
      - "-7.51 (apparent)"
      - "-3.72 (absolute)"
  - { section: "Surface Conditions" }
  - { label: "Effective Temperature", value: "283.5 K (~10.3 °C)" }
  - label: "Surface Temperature"
    value:
      - "Average: 316.5 K (43.3 °C)"
      - "Minimum: 286.5 K (13.3 °C)"
      - "Maximum: 346.5 K (73.3 °C)"
  - { label: "Surface Pressure", value: "11.6 psi" }
