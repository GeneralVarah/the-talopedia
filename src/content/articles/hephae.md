...
infobox:
  ...
  - label: "Orbital Period"
    value:
      - "91.64 days (sidereal)"
      - "84.30 days (synodic)"
  - { label: "Average Orbital Speed", value: "97.04 km/s" }
  - { section: "Rotational Characteristics" }
  - { label: "Axial Tilt", value: "0.03°" }
  - label: "Rotational Period"
    value:
      - "58.60 days (sidereal)"
      - "162.53 days (synodic)"
  - { section: "Physical Characteristics" }
  - { label: "Mass", value: "5.5000 × 10²³ kg" }
  - { label: "Surface Area", value: "1.0344 × 10⁸ km²" }
  - { label: "Volume", value: "9.8919 × 10¹⁰ km³" }
  - { label: "Mean Radius", value: "2,869 km" }
  - { label: "Mean Density", value: "5.56 g/cm³" }
  - { label: "Surface Gravity", value: "4.46 m/s²" }
  ...
  - { label: "Effective Temperature", value: "445 K (173 °C)" }
