...
ooc: true
infobox:
  - { image: "/assets/old-media/media/avium-1.jpg", caption: "" }
  - { section: "Orbital Characteristics" }
  - { label: "Central Body", value: "Ignian Barycenter" }
  - { label: "Semi-Major Axis", value: "1 AU" }
  - label: "Orbital Period"
    value:
      - "365.25 days (sidereal)"
      - "52.5 days (synodic)"
  - { label: "Average Orbital Speed", value: "61.2 km/s" }
  - { label: "Satellites", value: "1 (Selene)" }
  - { section: "Rotational Characteristics" }
  - { label: "Axial Tilt", value: "45°" }
  - label: "Rotational Period"
    value:
      - "23.9345 hours (sidereal)"
      - "24 hours (synodic)"
  - { section: "Physical Characteristics" }
  - { label: "Mass", value: "5.97217 × 10²⁴ kg" }
  - { label: "Surface Area", value: "5.10072 × 10⁸ km²" }
  - { label: "Volume", value: "1.08321 × 10¹² km³" }
  - { label: "Mean Radius", value: "6,371 km" }
  - { label: "Mean Density", value: "5.513 g/cm³" }
  - { label: "Surface Gravity", value: "9.80665 m/s²" }
  - { label: "Albedo", value: "0.3" }
  - { label: "Magnitude", value: "-3.6 (absolute)" }
  - { section: "Surface Conditions" }
  - { label: "Effective Temperature", value: "260.8 K (−12.4 °C)" }
  - label: "Surface Temperature"
    value:
      - "Average: 288.15 K (15 °C)"
      - "Minimum: 178.15 K (-95 °C)"
      - "Maximum: 336.15 K (63 °C)"
  - { label: "Surface Pressure", value: "14.7 psi" }
