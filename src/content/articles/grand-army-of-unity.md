---
title: "Grand Army of Unity"
type: military
nation: esu
infobox:
  - { image: "/assets/flags/grand-army-of-unity.png", caption: "Flag" }
  - label: "Motto"
    value:
      - "Si vis Pacem, Para Bellum"
      - "\"If you want Peace, Prepare for War\""
  - { label: "Founded", value: "July 26th, 1927" }
  ...
  - label: "Service Branches"
    value:
      ...
      - "Navy"
      - "Air Force"
  - { label: "Headquarters", value: "Nexus, [[elysian-state-of-unity]]" }
  - { section: "Leadership" }
  - { label: "Commander-in-Chief", value: "[[archer-maine]]" }
  - { label: "Minister of Defense", value: "[[arianne-malloran]]" }
  - { label: "General of the Army", value: "Arianne Malloran" }
  - { label: "Admiral of the Navy", value: "Anton Torres" }
  - { label: "General of the Air Force", value: "Jack Bartlett" }
  - { section: "Personnel" }
  - { label: "Military Age", value: "18" }
  - { label: "Conscription", value: "Selective" }
  - { label: "Active Personnel", value: "2,500,000" }
  - { label: "Reserve Personnel", value: "1,182,710" }
  - { section: "Expenditure" }
  - { label: "Budget (1934)", value: "$619,374,682,000" }
  - { label: "Percent of GDP", value: "12,7%" }
  - { section: "Industry" }
...
---
The **Grand Army of Unity** serves as the Elysian State of Unity's military force. It is organized into three primary branches: The Army, the Navy, and the Air Force.

## History

The history of [[elysia]]’s armed forces traces their roots to the military units organized by the various polities of the Territoria Elysiaca, also known as the Elysian Legions. While originally organized into units of more than 5000 men and 300 cavalry, the fall of the Rumaic Empire brought the paper and actual strength of Elysian Legions down into units of barely 1000 men and 100 cavalry. During the later years of the Triumvirate Period, some legions were reduced to units of barely 500 men, often spread out to police infrastructure and cities against bandits.

The history of the modern Elysian military dates back to the Continental Army formed on the 15th of August 1784, almost immediately following the August Degree declaring the Commonwealth of Elysia’s independence from the Elvesterian Empire. The Continental Navy and Continental Rangers were created in close succession later in October of 1784 to defend the nascent nation in the Elysian Revolutionary War.

All three branches were demobilized after the end of the war and quickly reformed into their modern-day equivalents during the 4th Continental Congress, coinciding with the official founding of the United States of Elysia.
...
Operationally, the Grand Army’s first proper engagement was Elysia’s expeditionary force sent to assist the United Socialist States of Sidanya in their civil war against nationalist rebels.

## Structure

The Grand Army comprises 3 principal service branches: the Unity State’s Army, Navy, and Air Force. Following reforms during the Grand Army’s formation, the Ranger Corps, which previously operated as a separate branch within the U.S. Armed Forces, has been transferred under the authority and command of the Army. The US. Coast Guard, which operates under the Ministry of the Interior's jurisdiction in peacetime, can be attached to the Navy's authority in wartime.
...
The **U.S. Sahara Command** (SAHARACOM), headquartered in Northgate and commanded by General of the Army Arianne Malloran, is responsible for the majority of the Unity State’s Saharan seaboard. SAHARACOM manages joint operations with Saint Testudera within the Western Sahara Sea and protects the industrial and political heartland of the ESU.

The **U.S. Southern Command** (SOUTHCOM), headquartered in Fort Freedom and commanded by General Jebediah Stark, is responsible for the southern regions of the country, primarily focused on managing the long land border with Hollosend.

The **U.S. Northern Command** (NORCOM) is headquartered in Charlotte and commanded by General William Peoples. It is responsible for the defense and management of the nation’s northern parts, including coordinating with Saint Testudera in the defense of the Sargassum Straits and management of the land border with the Thule Governorate.

The **U.S. Expeditionary Command** (EXPOCOM), headquartered in the Port of Muscovite and commanded by Admiral of the Navy Anton Torres, is responsible for all Elysian expeditionary missions outside of its own borders. Most recently, it has been in charge of overseeing the expeditionary forces sent to assist Sidanya in its civil war.

The **U.S. Special Operations Command** (SOCOM), headquartered in Nexus and commanded by General [[george-elwood]], is responsible for developing and employing special forces for the Unity State. Territorially, SOCOM also oversees all bases in extreme polar environments. Uniquely, SOCOM is attached to the State Intelligence Service's command.
